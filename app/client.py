...
class Babble (mongo_dao.MongoDAO, user.User, Security.Security):
    ...
    def __init__(self, user_id, passwd, username=''):
        ...
        self.port = 27526
        self.ip = '127.0.0.1'#'192.168.56.20'     #'127.0.0.1' #'54.88.104.208'
    ...
    def extract_payload(self, packet):
        ...
        elif drop_type == 'publickey':
            uid = self.personal_decrypt(drop[0])
            pkey = self.personal_decrypt(drop[1])

            js_obj = {"user_id":uid,"public_key":pkey}
